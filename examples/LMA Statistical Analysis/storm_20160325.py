...
lma_big_final = path + '/Pandas/Storm_20160325_pandas_big_final_lma.csv'
csv_big_final_source_count = path + '/Pandas/Storm_20160325_pandas_big_final' \
...
def plot_big_flashes(storm_big, nums, save_dir):
    ...
    for i in range(len(nums)):
        if nums[i] == 20943 or nums[i] == 21063:
            continue
...
# nums = st.pd.read_csv(path + '/Pandas/Figures/Storm_20160325_FirstRun_reanalyze'
#                              '.csv')
