...
# All Flashes
ods_all = path + '/ods/Cell1 Analysis 02242016.csv'
lma_all = path + '/Pandas/Storm_20160224_pandas_all_lma.csv'
csv_all_source_count = path + \
                       '/Pandas/Storm_20160224_pandas_all_lma_source_count' \
                       '.csv'

# Big Flashes
lma_big = path + '/Pandas/Storm_20160224_pandas_big_lma.csv'
csv_big_source_count = path + '/Pandas/Storm_20160224_pandas_big_lma_' \
                       'source_count.csv'

# ODS-LMA Matched Big Flashes
lma_big_matched = path + '/Pandas/Storm_20160224_pandas_big_matched_lma' \
                  '.csv'
ods_big_matched = path + '/Pandas/Storm_20160224_pandas_big_matched_ods' \
                  '.csv'
csv_big_matched_duplicates = path + '/Pandas/Storm_20160224_pandas_big_' \
...
lma_big_lessdups = path + \
                   '/Pandas/Storm_20160224_pandas_big_lessduplicates_lma' \
                   '.csv'

# ODS-LMA Matched Flashes After Splitting duplicates
lma_big_lessdups_matched = path + '/Pandas/Storm_20160224_pandas_big_' \
                           'lessduplicates_matched_lma.csv'
ods_big_lessdups_matched = path + '/Pandas/Storm_20160224_pandas_big_' \
                           'lessduplicates_matched_ods.csv'
csv_big_lessdups_matched_duplicates = path + '/Pandas/Storm_20160224_pandas_big_' \
...
# storm_ods = st.Storm.from_csv_file(file_name)
#
