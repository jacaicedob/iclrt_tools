...
ax.set_title('Base Reflectivity Z')
lma_plotter.scale_data(1E-3)
lma_plotter.set_cmap('grey')
...
ax.set_title(r'Differential Reflectivity $Z_{DR}$')
lma_plotter.scale_data(1E-3)
lma_plotter.set_cmap('grey')
lma_plotter.plot_proj(lims=[-20, 20], zlims=[0, 7], fig=fig, ax=ax)
...
ax.set_title(r'Cross Correlation Ratio $\rho_{HV}$')
lma_plotter.scale_data(1E-3)
lma_plotter.set_cmap('grey')
lma_plotter.plot_proj(lims=[-20, 20], zlims=[0, 7], fig=fig, ax=ax)
...
ax.set_title(r'Differential Phase $\phi_{DP}$')
lma_plotter.scale_data(1E-3)
lma_plotter.set_cmap('grey')
lma_plotter.plot_proj(lims=[-20, 20], zlims=[0, 7], fig=fig, ax=ax)
