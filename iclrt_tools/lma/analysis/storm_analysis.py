...
def initialize_colormap():
    """
    Same colormap as pyart NWSRef but with the lowest value being
    white
    """
    _NWSRef_data = {
        'blue': [
    ...
    cmap = mpl.colors.LinearSegmentedColormap('st_NWSRef', _NWSRef_data,
                                              mpl.rcParams['image.lut'])
    plt.register_cmap('st_NWSRef', cmap=cmap)
